        ...
        <S.Wrapper state={state}>
            <S.Header>
                ...
                <S.Title state={state}>
                    {title}
                    <div>
                        <FontAwesomeIcon icon={faPen} onClick={() => handleTodoUpdate(id, editContent)} />
                        <FontAwesomeIcon icon={faBan} onClick={handleTodoDelete} />
                    </div>
                </S.Title>
            </S.Header>
            <S.Content state={state}>
                {isEditMode ? <textarea defaultValue={content} onChange={onChangeEditContent}></textarea> : content}
            </S.Content>
        </S.Wrapper>
    );
};
